...
------------------------------------------------------------
-- Workflow 1 instance
INSERT INTO WORKFLOW_INSTANCE (INSTANCE_ID, WORKFLOW_ID, STATUS, STARTED_BY, STARTED_ON)
VALUES (1, 1, 'PENDING', 1, CURRENT_TIMESTAMP);

-- Workflow 2 instance
INSERT INTO WORKFLOW_INSTANCE (INSTANCE_ID, WORKFLOW_ID, STATUS, STARTED_BY, STARTED_ON)
VALUES (2, 2, 'PENDING', 4, CURRENT_TIMESTAMP);
